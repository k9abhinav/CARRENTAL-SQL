...
app.use(
  express.static(
    "C:\\Users\\k9abh\\OneDrive\\Documents\\fleeto-car-rental\\Car-rental-system\\server"
  )
);
// app.use(
//   express.static(
...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    cb(
      null,
      "C:\\Users\\k9abh\\OneDrive\\Documents\\fleeto-car-rental\\Car-rental-system\\server\\images"
